...
import com.project.webstore.dto.ProdutosDTO;
import com.project.webstore.resources.util.URL;
import com.project.webstore.services.ProdutosService;
...
public class ProdutoResources {
    ...
    public ResponseEntity<Page<ProdutosDTO>> findPage(
        ...
        Page<ProdutosDTO> listDto = list.map(obj -> new ProdutosDTO(obj));
